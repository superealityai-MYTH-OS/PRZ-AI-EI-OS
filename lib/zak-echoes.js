...
exports.zakEchoRegistry = void 0;
exports.findBestEcho = findBestEcho;
exports.canApplyEcho = canApplyEcho;
/**
 * Registry of pre-validated ZAK Echoes for common tasks
 */
exports.zakEchoRegistry = [
    {
 ...
 */
function canApplyEcho(echo, resonanceScore) {
